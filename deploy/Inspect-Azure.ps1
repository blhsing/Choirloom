param([ValidatePattern('^/api/')][string]$ApiPath='/api/vfs/site/choirloom-app/')
...
@{path=$ApiPath;authorization=$authorization} | ConvertTo-Json -Compress | python -X utf8 (Join-Path $PSScriptRoot 'azure-inspect.py')
